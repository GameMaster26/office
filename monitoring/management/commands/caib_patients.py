...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        default_municipality = Municipality.objects.get(muni_id=4)
        ...
        def create_patients_with_history_and_treatment(n=10):
            ...
            for i in range(n):
                ...
                if date_registered > date(2024, 12,31):
                    date_registered = date(2024, 12,31) 
                       
                    # Cap it to March 31st if it exceeds
        ...
        create_patients_with_history_and_treatment(5)
