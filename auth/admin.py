...
class UserAdmin(admin.ModelAdmin):
    ...
    def has_change_permission(self, request, obj=None):
        if obj is not None:
            ...
            # Allow user to edit only their profile
                ...
                return True
            # Other users can only view profiles, no edit permission
            else:
                return False
        return True
    ...
    def get_readonly_fields(self, request, obj=None):
        ...
        if obj and obj != request.user:
            # Regular users cannot edit others, so all fields are readonly
            return ("username",  "first_name", "last_name", "email")
        return ("code","password",) # Password remains read-only for everyone
